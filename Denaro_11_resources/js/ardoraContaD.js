...
var newHtml="";if ($.trim(im[ram_G[indexGame]])){newHtml='<img id="imaL" class="imaLeft" alt="'+imalt[ram_G[indexGame]]+'" src="Denaro_11_resources/media/'+im[ram_G[indexGame]]+'">';}
newHtml=newHtml+te[ram_G[indexGame]];$("#actText").html(newHtml);
$("#imaL").attr("tabindex","0");if ($.trim(im[ram_G[indexGame]])) {$( "#imaL" ).css("cursor","pointer");$( "#imaL" ).click(function() {imaUp("Denaro_11_resources/media/G" + im[ram_G[indexGame]],imalt[ram_G[indexGame]])});
$("#imaL").keydown(function(e){if (e.which!=9){ imaUp("Denaro_11_resources/media/G" + im[ram_G[indexGame]],imalt[ram_G[indexGame]])}});
}
$("#actText").css("minHeight",imaH[ram_G[indexGame]]);$(".buttonAu").remove();
if ($.trim(a1[ram_G[indexGame]])){$("#origin").append('<img alt="Play" class="buttonAu" src="Denaro_11_resources/media/sound.png"/>');
